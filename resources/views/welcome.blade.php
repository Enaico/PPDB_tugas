...
<head>
    ...
    <title>PPDB - SMK 1 Antartika SDA</title>
...
<body>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light navbar-float">
            <div class="container">
                <a href="index.html" class="navbar-brand"><span class="text-primary">PPDB</span></a>
                ...
                <div class="navbar-collapse collapse" id="navbarContent">
                    ...
                    <div class="ml-auto">
                        <a href="#" class="btn btn-outline rounded-pill">Login Admin</a>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="container h-100">
                <div class="row align-items-center h-100">
                    <div class="col-lg-6 py-3 wow fadeInUp">
                        ...
                        <a href="#" class="btn btn-outline border text-secondary">Register</a>
                        <a href="#" class="btn btn-primary btn-split ml-2">Login Siswa <div class="fab"><span
